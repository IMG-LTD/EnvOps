...
export const useRouteStore = defineStore(SetupStoreId.Route, () => {
  ...
  function getKnownAuthRoutes() {
    const { authRoutes: staticAuthRoutes } = createStaticRoutes();

    return [...staticAuthRoutes, ...authRoutes.value];
  }
  ...
  async function initConstantRoute() {
    ...
    if (authRouteMode.value === 'static') {
      ...
      if (!error) {
        // keep local constant routes authoritative to preserve route shapes such as login/:module
        addConstantRoutes([...data, ...staticRoute.constantRoutes]);
      } else {
  ...
  async function getIsAuthRouteExist(routePath: RouteMap[RouteKey]) {
    ...
    return isRouteExistByRouteName(routeName, getKnownAuthRoutes());
  }
