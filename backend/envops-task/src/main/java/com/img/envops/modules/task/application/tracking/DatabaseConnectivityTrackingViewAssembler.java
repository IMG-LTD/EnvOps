...
@Component
public class DatabaseConnectivityTrackingViewAssembler implements UnifiedTaskTrackingViewAssembler {
  private final TrackingViewSupport support;

  public DatabaseConnectivityTrackingViewAssembler(TrackingViewSupport support) {
    this.support = support;
  }

  @Override
  public boolean supports(String taskType) {
    return "database_connectivity".equalsIgnoreCase(taskType);
  }
