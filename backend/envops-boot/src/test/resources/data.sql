...
VALUES
    (1, 'envops-admin', 'EnvOps@123'),
    (20, 'release-admin', 'Release@123');
...
INSERT INTO deploy_task (id, task_no, task_name, task_type, app_id, version_id, origin_task_id, status, batch_strategy, batch_size, target_count, success_count, fail_count, operator_name, started_at, finished_at, deleted, created_by, updated_by, created_at, updated_at)
VALUES
    (2001, 'DT202604151600000001', 'seed-order-service-install', 'INSTALL', 1001, 1401, NULL, 'SUCCESS', 'ALL', 0, 1, 1, 0, 'envops-admin', TIMESTAMP '2026-04-15 16:00:00', TIMESTAMP '2026-04-15 16:05:00', 0, 'seed', 'seed', TIMESTAMP '2026-04-15 16:00:00', TIMESTAMP '2026-04-15 16:05:00');
